...
func _ready():
	...
	if level_script and level_script.has_signal("enemy_spawned"):
		...
		print("Flood light connected to enemy_spawned signal")
...
func flicker_light():
	...
	var flood_mesh_instance = $FloodLight
	if flood_mesh_instance and flood_mesh_instance is MeshInstance3D:
		var material = flood_mesh_instance.get_surface_override_material(1)
		if material and material is StandardMaterial3D:
			material.emission_enabled = true
	
	is_flickering = false
	print("Flood light finished flickering")
